  ...
  return (
    <div className="space-y-4 select-none">
      ...
      <div className="relative touch-none overscroll-contain">
        ...
        >
          <defs>
            {/* Both gradients are vertical so color tracks UV VALUE (not time of day):
                red at the top (high UV), green at the bottom (low UV). */}
            ...
            <linearGradient id="uv-line" x1="0" y1="0" x2="0" y2="1" gradientUnits="userSpaceOnUse">
              ...
              <stop offset="100%" stopColor="hsl(140 65% 50%)" />
            </linearGradient>
          </defs>
