...
const translations: Record<Language, Record<string, string>> = {
  'en-GB': {
    ...
    'hourly.feelsLike': 'Feels Like',
    'hourly.precipitation': 'Precipitation',
    'hourly.wind': 'Wind',
    'hourly.humidity': 'Humidity',
    
    // Prediction Dialog
    'predict.title': 'Weather Predictions',
    'predict.subtitle': 'Test your forecasting skills and climb the leaderboard',
    'predict.tab.predict': 'Predict',
    'predict.tab.leaders': 'Leaders',
    'predict.tab.history': 'History',
    'predict.tab.shop': 'Shop',
    'predict.rank': 'Rank',
    'predict.streak': 'Streak',
    'predict.total': 'Total',
    'predict.accuracy': 'Accuracy',
    'predict.howPoints': 'How Points Work',
    'predict.allCorrect': 'All 3 correct (1x)',
    'predict.twoCorrect': '2 correct (1x)',
    'predict.oneCorrect': '1 correct (1x)',
    'predict.allWrong': 'All wrong (1x)',
    'predict.confidenceTip': '🔥 Use Confidence Betting to multiply your rewards (and risks)! Up to 2.5x with All-In.',
    'predict.button': 'Predict & Compete',
    'predict.leaderboard': 'Leaderboard',
    'predict.allTime': 'All Time',
    'predict.weekly': 'This Week',
    'predict.monthly': 'This Month',
    'predict.seasonal': 'This Season',
    'predict.myLeagues': 'My Leagues',
    ...
    'map.windLayer': 'Wind Speed Layer',
    'map.opacity': 'Opacity',
    'map.precipLegend': 'Precipitation',
    'map.tempLegend': 'Temperature',
    'map.windLegend': 'Wind Speed',
  ...
  'boomer': {
    ...
    // Hourly Detail Dialog
    'hourly.forecast': 'What The Weather Might Do',
    'hourly.feelsLike': 'What It REALLY Feels Like',
    'hourly.precipitation': 'Rain Chance',
    'hourly.wind': 'How Breezy',
    'hourly.humidity': 'The Sticky Air',
    
    // Prediction Dialog
    'predict.title': 'Guess Tomorrow\'s Weather!',
    'predict.subtitle': 'Think you\'re smarter than the weatherman? Prove it!',
    'predict.tab.predict': 'Guess',
    'predict.tab.leaders': 'Winners',
    'predict.tab.history': 'Old Guesses',
    'predict.tab.shop': 'Buy Stuff',
    'predict.rank': 'Place',
    'predict.streak': 'Hot Streak',
    'predict.total': 'Guesses',
    'predict.accuracy': 'How Right',
    'predict.howPoints': 'How The Points Thingy Works',
    'predict.allCorrect': 'Nailed all 3! (1x)',
    'predict.twoCorrect': 'Got 2 right (1x)',
    'predict.oneCorrect': 'Got 1 right (1x)',
    'predict.allWrong': 'Totally wrong (1x)',
    'predict.confidenceTip': '🔥 Feeling lucky? Bet big and win big! (Or lose big... like Vegas)',
    'predict.button': 'Guess The Weather!',
    'predict.leaderboard': 'Who\'s Winning',
    'predict.allTime': 'All Time',
    'predict.weekly': 'This Week',
    'predict.monthly': 'This Month',
    'predict.seasonal': 'This Season',
    'predict.myLeagues': 'My Clubs',
    
    // Weather Map
    'map.title': 'The Weather Map (Like On TV!)',
    'map.rain': '🌧 Rain Stuff',
    'map.temp': '🌡 Hot/Cold',
    'map.wind': '💨 Breezy',
    'map.past': 'Already Happened',
    'map.forecast': 'Coming Up',
    'map.tempHeatmap': 'The Hot & Cold Colors',
    'map.windLayer': 'The Breezy Arrows',
    'map.opacity': 'See-Through-Ness',
    'map.precipLegend': 'Rain Amount',
    'map.tempLegend': 'Hot or Cold',
    'map.windLegend': 'How Breezy',
